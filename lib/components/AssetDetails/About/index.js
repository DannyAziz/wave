...
import {SubtlePill as Pill} from '@lib/components/Pill';
...
const About = ({asset}) => {
  ...
  return (
    <View>
      <Styled.Text>
        {asset.description ? asset.description : asset.collection.description}
      </Styled.Text>
      <Styled.Links
...
export const AssetBundleAbout = ({description}) => (
